rem mongod --port 27018 --dbpath C:\Users\185961\Documents\topicos1\mongo\baserequisicoes --auth
mongod --port 27018 --dbpath C:\Users\david\Documents\topicos1\mongo\baserequisicoes --auth
